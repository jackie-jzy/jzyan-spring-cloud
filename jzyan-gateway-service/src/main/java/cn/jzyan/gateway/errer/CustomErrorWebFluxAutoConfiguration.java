 ...
 * @FileName : CustomErrorWebFluxAutoConfiguration
 * @Version : 1.0.0
 * @Package : cn.jzyan.gateway.errer
 * @Description : 自定义异常处理器
 * @Author : jzyan
 * @CreateDate : 2020/05/21 13:57
 */
@Configuration
...
public class CustomErrorWebFluxAutoConfiguration {
    ...
    public ErrorWebExceptionHandler errorWebExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties, ObjectProvider<ViewResolver> viewResolvers, ServerCodecConfigurer serverCodecConfigurer, ApplicationContext applicationContext) {
        JsonErrorWebExceptionHandler exceptionHandler = new JsonErrorWebExceptionHandler(errorAttributes, resourceProperties, this.serverProperties.getError(), applicationContext);
