 ...
 * @FileName : CustomOAuthExceptionTranslator
 * @Version : 1.0.0
 * @Package : cn.jzyan.oauth2.errer
 * @Description : 自定义认证异常输出
 * @Author : jzyan
 * @CreateDate : 2020/05/23 10:28
 */
@Component
public class CustomOauthExceptionTranslator implements WebResponseExceptionTranslator {
